...
namespace vazel
{
    namespace core
    {
        ...
        int64_t Drawable::getLayer(void) const
        {
            return _layer;
        }
        bool Drawable::shouldDraw(void) const
        {
            return _shouldDraw;
        }
        void Drawable::setLayer(int64_t layer)
        {
            _layer = layer;
        }
        void Drawable::setShouldDraw(bool shouldDraw)
        {
